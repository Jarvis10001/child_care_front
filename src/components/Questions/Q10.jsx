  ...
  const questions = [
    {
      ...
      questions: [{ id: 'grossMotor', text: 'Can the child walk up and down stairs alone?' }],
    },
    {
      category: 'Fine Motor',
      questions: [{ id: 'fineMotor', text: 'Can the child draw a circle?' }],
    },
    {
      category: 'Language/Communication',
      questions: [{ id: 'language', text: 'Can the child say about 50 words?' }],
    },
    {
      category: 'Cognitive',
      questions: [{ id: 'cognitive', text: 'Does the child use objects to pretend?' }],
    },
    {
      category: 'Social/Emotional',
      questions: [{ id: 'socialEmotional', text: 'Does the child play next to other children and sometimes with them?' }],
    },
  ];
        ...
        >
          ...
          <div className="text-center mb-16 relative">
            ...
            >
              ...
              <span className="text-[#4CAF50] text-sm font-semibold">27-30 Months Assessment</span>
            </motion.div>
            ...
            <p className="text-lg text-[#6C757D] max-w-2xl mx-auto leading-relaxed">
              Track your child's progress during the crucial 27-30 month development period
            </p>
          </div>
          ...
          <div className="flex justify-center mt-16">
            ...
            >
              <span className="flex items-center gap-2">
                {submitted ? '27-30 Months Assessment Completed' : 'Submit Assessment'}
          ...
          {submitted && (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#333333]">27-30 Months Assessment Completed</h3>
