...
const Q15 = () => {
  ...
  // ...existing handlers (handleChange, handleSubmit, calculateProgress)...

  const questions = [
    {
      category: 'Gross Motor',
      questions: [{ id: 'grossMotor', text: 'Can the child catch a bounced ball?' }],
    },
    {
      category: 'Fine Motor',
      questions: [{ id: 'fineMotor', text: 'Can the child button their clothes?' }],
    },
    {
      category: 'Language/Communication',
      questions: [{ id: 'language', text: 'Can the child speak clearly enough for strangers to understand them?' }],
    },
    {
      category: 'Cognitive',
      questions: [{ id: 'cognitive', text: 'Can the child count to ten?' }],
    },
    {
      category: 'Social/Emotional',
      questions: [{ id: 'socialEmotional', text: 'Does the child play cooperatively with other children?' }],
    },
  ];
        ...
        >
          ...
          <div className="text-center mb-16 relative">
            ...
            >
              ...
              <span className="text-[#4CAF50] text-sm font-semibold">42-45 Months Assessment</span>
            </motion.div>
            ...
            <p className="text-lg text-[#6C757D] max-w-2xl mx-auto leading-relaxed">
              Track your child's progress during the crucial 42-45 month development period
            </p>
          </div>
          ...
          <div className="flex justify-center mt-16">
            ...
            >
              <span className="flex items-center gap-2">
                {submitted ? '42-45 Months Assessment Completed' : 'Submit Assessment'}
          ...
          {submitted && (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#333333]">42-45 Months Assessment Completed</h3>
