  ...
  const questions = [
    {
      ...
      questions: [{ id: 'grossMotor', text: 'Can the child ride a tricycle?' }],
    },
    {
      category: 'Fine Motor',
      questions: [{ id: 'fineMotor', text: 'Can the child copy a cross or square?' }],
    },
    {
      category: 'Language/Communication',
      questions: [{ id: 'language', text: 'Can the child answer simple questions?' }],
    },
    {
      category: 'Cognitive',
      questions: [{ id: 'cognitive', text: 'Can the child understand the concept of "same" and "different?"' }],
    },
    {
      category: 'Social/Emotional',
      questions: [{ id: 'socialEmotional', text: 'Does the child enjoy playing with other children?' }],
    },
  ];
        ...
        >
          ...
          <div className="text-center mb-16 relative">
            ...
            >
              ...
              <span className="text-[#4CAF50] text-sm font-semibold">36-39 Months Assessment</span>
            </motion.div>
            ...
            <p className="text-lg text-[#6C757D] max-w-2xl mx-auto leading-relaxed">
              Track your child's progress during the crucial 36-39 month development period
            </p>
          </div>
          ...
          <div className="flex justify-center mt-16">
            ...
            >
              <span className="flex items-center gap-2">
                {submitted ? '36-39 Months Assessment Completed' : 'Submit Assessment'}
          ...
          {submitted && (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#333333]">36-39 Months Assessment Completed</h3>
