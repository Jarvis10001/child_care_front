  ...
  const questions = [
    {
      ...
      questions: [
        {
          id: 'grossMotor1',
          text: 'Does the baby crawl?',
        },
        {
          id: 'grossMotor2',
          text: 'Can they pull themselves up to stand?',
        },
      ],
    },
    {
      ...
      questions: [
        {
          id: 'fineMotor',
          text: 'Does the baby use their fingers to point?',
        },
      ],
    },
    {
      ...
      questions: [
        {
          id: 'language',
          text: 'Does the baby imitate sounds?',
        },
      ],
    },
    {
      ...
      questions: [
        {
          id: 'cognitive',
          text: 'Does the baby put objects in a container?',
        },
      ],
    },
    {
      ...
      questions: [
        {
          id: 'socialEmotional',
          text: 'Does the baby wave bye-bye?',
        },
      ],
    },
  ];
        ...
        >
          ...
          <div className="text-center mb-16 relative">
            ...
            >
              ...
              <span className="text-[#4CAF50] text-sm font-semibold">9-12 Months Assessment</span>
            </motion.div>
            ...
            <p className="text-lg text-[#6C757D] max-w-2xl mx-auto leading-relaxed">
              Track your child's progress during the crucial 9-12 month development period
            </p>
          </div>
          ...
          {submitted && (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#333333]">9-12 Months Assessment Completed</h3>
                  <p className="text-[#6C757D]">Thank you for completing the 9-12 months milestone assessment</p>
                </div>
              </div>
            </motion.div>
          )}
