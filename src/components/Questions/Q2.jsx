  ...
  const questions = [
    {
      ...
      questions: [
        {
          id: 'grossMotor1',
          text: 'Does the baby bring hands together?',
        },
        {
          id: 'grossMotor2',
          text: 'Does the baby roll from tummy to back?',
        },
      ],
    },
    {
      ...
      questions: [
        {
          id: 'fineMotor',
          text: 'Does the baby reach for objects?',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      questions: [
        {
          id: 'cognitive',
          text: 'Does the baby respond to familiar voices?',
        },
      ],
    },
    {
      ...
      questions: [
        {
          id: 'socialEmotional',
          text: 'Does the baby smile spontaneously?',
        },
      ],
    },
  ];
        ...
        >
          ...
          <div className="text-center mb-16 relative">
            ...
            >
              ...
              <span className="text-[#4CAF50] text-sm font-semibold">3-6 Months Assessment</span>
            </motion.div>
            ...
            <p className="text-lg text-[#6C757D] max-w-2xl mx-auto leading-relaxed">
              Track your child's progress during the crucial 3-6 month development period
            </p>
          </div>
          ...
          <div className="bg-white/70 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-gray-100 mb-12 relative overflow-hidden">
            ...
            <div className="flex justify-between items-center mb-4">
              <div>
                <h3 className="text-lg font-semibold text-[#333333]">3-6 Months Assessment Progress</h3>
          ...
          <div className="flex justify-center mt-16">
            ...
            >
              <span className="flex items-center gap-2">
                {submitted ? '3-6 Months Assessment Completed' : 'Submit Assessment'}
          ...
          {submitted && (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#333333]">3-6 Months Assessment Completed</h3>
                  <p className="text-[#6C757D]">Thank you for completing the 3-6 months milestone assessment</p>
                </div>
              </div>
            </motion.div>
          )}
