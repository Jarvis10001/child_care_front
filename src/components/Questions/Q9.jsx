  ...
  const questions = [
    {
      ...
      questions: [{ id: 'grossMotor', text: 'Can the child jump with both feet?' }],
    },
    {
      category: 'Fine Motor',
      questions: [{ id: 'fineMotor', text: 'Can the child turn door knobs?' }],
    },
    {
      category: 'Language/Communication',
      questions: [{ id: 'language', text: 'Can the child use two-word phrases?' }],
    },
    {
      category: 'Cognitive',
      questions: [{ id: 'cognitive', text: 'Does the child know the names of body parts?' }],
    },
    {
      category: 'Social/Emotional',
      questions: [{ id: 'socialEmotional', text: 'Does the child show affection to familiar people?' }],
    },
  ];
        ...
        >
          ...
          <div className="text-center mb-16 relative">
            ...
            >
              ...
              <span className="text-[#4CAF50] text-sm font-semibold">24-27 Months Assessment</span>
            </motion.div>
            ...
            <p className="text-lg text-[#6C757D] max-w-2xl mx-auto leading-relaxed">
              Track your child's progress during the crucial 24-27 month development period
            </p>
          </div>
          ...
          <div className="bg-white/70 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-gray-100 mb-12 relative overflow-hidden">
            ...
            <div className="flex justify-between items-center mb-4">
              <div>
                <h3 className="text-lg font-semibold text-[#333333]">24-27 Months Assessment Progress</h3>
          ...
          <div className="flex justify-center mt-16">
            ...
            >
              <span className="flex items-center gap-2">
                {submitted ? '24-27 Months Assessment Completed' : 'Submit Assessment'}
          ...
          {submitted && (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#333333]">24-27 Months Assessment Completed</h3>
